...
type MarkdownRemarkFrontmatter = {
  readonly appstore: Maybe<Scalars['String']>;
...
type MarkdownRemarkFrontmatterFieldSelector = {
  readonly appstore: InputMaybe<FieldSelectorEnum>;
...
type MarkdownRemarkFrontmatterFilterInput = {
  readonly appstore: InputMaybe<StringQueryOperatorInput>;
...
type MarkdownRemarkFrontmatterSortInput = {
  readonly appstore: InputMaybe<SortOrderEnum>;
...
type allFeaturedProjectsQueryVariables = Exact<{ [key: string]: never; }>;


type allFeaturedProjectsQuery = { readonly featured: { readonly edges: ReadonlyArray<{ readonly node: { readonly html: string | null, readonly frontmatter: { readonly title: string | null, readonly tech: ReadonlyArray<string | null> | null, readonly github: string | null, readonly external: string | null, readonly appstore: string | null, readonly googleplay: string | null, readonly cover: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } }> } };
...
type AllProjectsQuery = { readonly projects: { readonly edges: ReadonlyArray<{ readonly node: { readonly html: string | null, readonly frontmatter: { readonly title: string | null, readonly tech: ReadonlyArray<string | null> | null, readonly github: string | null, readonly external: string | null } | null } }> } };
...
type SiteQuery = { readonly site: { readonly siteMetadata: { readonly siteUrl: string | null, readonly defaultTitle: string | null, readonly defaultDescription: string | null, readonly defaultImage: string | null } | null } | null };
